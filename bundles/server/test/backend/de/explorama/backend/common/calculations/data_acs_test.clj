(ns de.explorama.backend.calculations.data-acs-test
  (:require [clojure.test :refer [testing deftest is]]
            [de.explorama.backend.calculations.data-acs :as acs]))
...
(deftest data-acs
  (testing "handle-string"
    ...
    (is (= #{"Civilians (Benin)" "Police Forces of Benin (1996-2006)" "Protesters (Benin)"}
           (acs/handle-string "Protesters (Benin)"  #{"Civilians (Benin)" "Police Forces of Benin (1996-2006)" "Protesters (Benin)"}))))
  (testing "date-min"
