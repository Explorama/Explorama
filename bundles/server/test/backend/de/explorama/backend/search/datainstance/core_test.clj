(ns de.explorama.backend.search.datainstance.core-test
  (:require [clojure.test :refer [deftest is testing use-fixtures]]
            [de.explorama.backend.search.config :as config-search]
            [de.explorama.backend.search.datainstance.core :refer [gen-di]]))

;; this method is not used any more, should be removed from suche.datainstance.core

(deftest test-acs->ac-map
  (testing "wrong result"
    (is true)))

(def ref-config {:fulltext {:content-api "http://localhost:3000/fulltext?access-permission=abc&ref="
                            :query-api "http://localhost:3000/fulltext-query?access-permission=abc&ref=" :type :string}
                 :Fulltext {:content-api "http://localhost:3000/fulltext"
                            :query-api "http://localhost:3000/fulltext-query" :type :string}})
...
(def gen-di-result #:di{:data-tile-ref {"ebc12d8f3c27c2031d00844089ac8265b522e7ed56bc117be124608628073fe3"
                        ...
                        :operations [:filter "0b5a3a3424f0239ff14443540c3ae259fbf2bd3b4768e2596d2826562878a3b8" "ebc12d8f3c27c2031d00844089ac8265b522e7ed56bc117be124608628073fe3"],
