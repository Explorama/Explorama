(ns de.explorama.backend.visualization.components.chart-types.bar-chart-test
  (:require [clojure.test :refer :all]
            [de.explorama.shared.common.test-data :as td]
            [de.explorama.backend.visualization.shared.util :refer [colors]]
            [de.explorama.backend.visualization.components.charts.base-charts :refer [base-bar-settings]]
