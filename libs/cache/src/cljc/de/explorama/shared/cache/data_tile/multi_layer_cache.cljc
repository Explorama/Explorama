(ns de.explorama.shared.cache.data-tile.multi-layer-cache
  (:require [de.explorama.shared.cache.data-tile.multi-layer.storage :as storage]
            [de.explorama.shared.cache.data-tile.invalidate :as invalidate]
...
(defn init [retrieval-config
  ...
  (let [retrieval (retrieval/init retrieval-config data-tile-services miss-http-req)
        invalidate (invalidate/init cache-services delete-propagation-http-req)
