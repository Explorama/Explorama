(ns data-format-lib.operations-mosaic-test
  (:require [data-format-lib.operations :as of]
...
(t/deftest sub-group-by-with-aggregations-test
  ...
  (t/testing "sort sub groups by org for sub grouped data with filter"
    (t/is (= (of/perform-operation {"di-1" input-data}
                                   {"f1" [:and [:or {:data-format-lib.filter/op :=,
                                                     :data-format-lib.filter/prop td/country,
                                                     :data-format-lib.filter/value td/country-a}]]}
                                   [:sort-by {:attribute td/fact-1
                                              :attribute-types {td/fact-1 :number}
                                              :direction :desc
                                              :return-map? false
