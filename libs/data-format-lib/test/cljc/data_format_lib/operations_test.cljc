...
(def org=org-1 [:and {:data-format-lib.filter/op :has, :data-format-lib.filter/prop td/org, :data-format-lib.filter/value (td/org-val 1)}])
...
(def category-1=category-A-2 [:and {:data-format-lib.filter/op :has, :data-format-lib.filter/prop td/category-1, :data-format-lib.filter/value (td/category-val 2 "A")}])
(def org=org-6 [:and {:data-format-lib.filter/op :has, :data-format-lib.filter/prop td/org, :data-format-lib.filter/value (td/org-val 6)}])
