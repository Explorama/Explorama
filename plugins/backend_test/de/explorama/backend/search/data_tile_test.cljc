(ns de.explorama.backend.search.data-tile-test
  (:require [clojure.test :refer [deftest is testing]]
            [de.explorama.backend.search.datainstance.core :refer [reduce-formdata]]
            [de.explorama.backend.expdb.legacy.search.data-tile-ref :as expdb-dt-ref]))
...
(deftest test-data-tile-reduce-formdata
  (testing "data-tile reduce-formdata"
    (is (=
         ...
         (@#'expdb-dt-ref/data-tile-reduce-formdata
          test-attributes
          test-formdata)))))
