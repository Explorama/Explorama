(ns de.explorama.shared.cache.data-tile.local
  (:require [de.explorama.shared.cache.data-tile.local.retrieval :as retrieval]
...
(defn init [retrieval-config
  ...
  (let [retrieval (retrieval/init retrieval-config miss)
