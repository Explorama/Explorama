...
(def country-a-datasource-a-data
  [{{datasource datasource-a
     ...
     "identifier" "search"
     country    country-a
     "bucket"     "default"} [{country    country-a,
...
(def country-b-datasource-a-data
  [{{datasource datasource-a
     ...
     "identifier" "search"
     country    country-b
     "bucket"     "default"} [{country    country-b
                               category-1 (category-val 1 "B")
                               "id"         (id-val "B" 1)
                               datasource datasource-a
                               org        (org-val 1)
...
(def all-events (set (concat (flatten (map vals country-b-datasource-a-data))
                             (flatten (map vals country-a-datasource-a-data)))))
