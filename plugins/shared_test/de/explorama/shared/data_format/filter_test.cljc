(ns de.explorama.shared.data-format.filter-test
  (:require
   [de.explorama.shared.data-format.filter :as filter]
  ...
  (t/testing
   "compile-filter handles any type of sequence, not only vectors."
    (t/is (fn? (compile-filter ff/default-impl
                               [:and (list :or #:de.explorama.shared.data-format.filter{:op :includes, :prop "notes", :value "BoMB"})])))))
